...
import img5 from "../../assets/movie-app-project.png";
import img6 from "../../assets/social-media-js-project.png";

const Projects = [
  {
    id: 6,
    name: "Movie App-React|Redux",
    description:
    ...
    link: "https://db-movie-app.vercel.app/",
  },
  {
    id: 5,
    name: "Quiz App-React",
  ...
  {
    id: 4,
    name: "Social Media-JS",
    description:
      "This social media app is just a ui of social media chatting app made with HTML and CSS.Also,the functionality like theme customization, notification popup are added with JavaScript.",
    img: img6,
    github: "https://github.com/diwashbhattarai999/social_media_js",
    link: "https://diwashbhattarai999.github.io/social_media_js/",
  },
  {
    id: 3,
